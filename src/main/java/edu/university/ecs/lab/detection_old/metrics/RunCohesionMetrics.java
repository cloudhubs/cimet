...
import edu.university.ecs.lab.detection_old.metrics.models.Operation;
import edu.university.ecs.lab.detection_old.metrics.models.ServiceDescriptor;
import edu.university.ecs.lab.detection_old.metrics.services.MetricCalculator;
import edu.university.ecs.lab.detection_old.metrics.services.MetricResult;
import edu.university.ecs.lab.detection_old.metrics.services.MetricResultCalculation;
...
public class RunCohesionMetrics {
     ...
     */
    public static MetricResultCalculation calculateCohesionMetrics(String IRPath) throws IOException {
